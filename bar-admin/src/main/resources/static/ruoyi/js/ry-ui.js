...
(function ($) {
    $.extend({
        ...
        table: {
            ...
            // 图片预览
            imageView: function (value, height, width, target , circle) {
                ...
                if (width == 'auto') {
                	...
                	return $.common.sprintf("<img class='%s img-circle' style='width:%spx ; height:%spx;border-radius:0px' data-height='auto' data-width='auto' data-target='%s' src='%s'/>",circle?'img-circle':'', width,height, _target, value);

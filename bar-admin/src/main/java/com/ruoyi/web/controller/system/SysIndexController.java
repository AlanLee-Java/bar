...
public class SysIndexController extends BaseController
{
    ...
    public String main(ModelMap mmap)
    {
		...
		if (CollUtil.isNotEmpty(roles) && roles.get(0).getRoleId().equals(Merchant.ROLE_MERCHANT)) {
			Merchant merchant = merchantService.getBySysUserId(user.getUserId());
			mmap.put("merchant", merchant);
			mmap.put("data", merchantMapper.selectMerchantSumOrder(merchant.getId()));
		}
        mmap.put("version", RuoYiConfig.getVersion());
        return "system/merchant/main";
    }

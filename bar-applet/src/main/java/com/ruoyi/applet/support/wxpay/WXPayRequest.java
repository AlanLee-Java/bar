...
import static com.ruoyi.applet.support.wxpay.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        try {
            ...
            exception = ex;
            firstHasDnsErr = true;
            elapsedTimeMillis = com.ruoyi.applet.support.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            com.ruoyi.applet.support.wxpay.WXPayUtil.getLogger().warn("UnknownHostException for domainInfo {}", domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = com.ruoyi.applet.support.wxpay.WXPayUtil.getCurrentTimestampMs() - startTimestampMs;
            com.ruoyi.applet.support.wxpay.WXPayUtil.getLogger().warn("timeout happened for domainInfo {}", domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,

...
public class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        private String sdk = com.ruoyi.applet.support.wxpay.WXPayConstants.WXPAYSDK_VERSION;
        ...
        public String toLineString(String key) {
            ...
            try {
                String sign = com.ruoyi.applet.support.wxpay.WXPayUtil.HMACSHA256(sb.toString(), key);
                sb.append(sign);
                return sb.toString();
            } catch (Exception ex) {
                return null;
    ...
    private com.ruoyi.applet.support.wxpay.WXPayConfig config;
    private ExecutorService executorService;

    private volatile static WXPayReport INSTANCE;

    private WXPayReport(final com.ruoyi.applet.support.wxpay.WXPayConfig config) {
        this.config = config;
                    ...
                    public void run() {
                        while (true) {
                            ...
                            try {
                                ...
                                com.ruoyi.applet.support.wxpay.WXPayUtil.getLogger().warn("report fail. reason: {}", ex.getMessage());
                            }
                        }
                    }
                });
     ...
     * @return
     */
    public static WXPayReport getInstance(com.ruoyi.applet.support.wxpay.WXPayConfig config) {
        if (INSTANCE == null) {
    ...
    public void report(String uuid, long elapsedTimeMillis,
        ...
        long currentTimestamp = com.ruoyi.applet.support.wxpay.WXPayUtil.getCurrentTimestamp();
    ...
    private static String httpRequest(String data, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        httpPost.addHeader("User-Agent", com.ruoyi.applet.support.wxpay.WXPayConstants.USER_AGENT);
